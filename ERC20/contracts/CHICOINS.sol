...
contract CHICOINS is ERC20, Ownable {
    ...
    function stake(uint256 amount) public {
        ...
        require(adjustedAmount > 0, "Please stake more than 0 token");
        require(balanceOf(msg.sender) >= adjustedAmount, "You do not have enough balance");
    ...
    function withdraw() public {
        ...
        require(_stakes[msg.sender] > 0, "You do not have staked tokens");
